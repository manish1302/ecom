    ...
    <>
      <div className="Home">
        ...
        <Container className="mt-3">
          <Row>
            ...
            <Col lg={6} xs={12} className="home-img-col">
              {active && (
                <Skeleton.Image
                  active={true}
                  style={{ width: "266.67px", height: "25rem" }}
                />
              )}
              <img
                src={homeimg}
          ...
          <Row className="m-5">
            <Col lg={6} sm={12} className="d-flex flex-column align-items-end">
              <div style={{ width: "70%" }}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="m-1">
                    <Button className="choose-a-chair mb-3">Sleep on it</Button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <Footer className="Home-footer">
        ...
        <div className="terms-row d-flex justify-content-between align-items-center w-100">
          ...
          <div className="terms d-flex">
            <div className="" style={{ marginRight: "16px", color: "#E6E4E0" }}>
              Terms
            </div>
            <div className="" style={{ marginRight: "16px", color: "#E6E4E0" }}>
              Privacy
